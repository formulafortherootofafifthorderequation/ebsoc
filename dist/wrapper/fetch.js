...
exports.scheduleList = exports.notificationCount = exports.fetchNotice = exports.fetchClassList = exports.TAB_TYPE = exports.SEARCH_TYPE = exports.fetchUserData = void 0;
var __1 = require("..");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, __1.Common.member(token)];
                case 1:
                    res = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, __1.Cls.mypage.myClassListByTabType(token, data)];
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, { data: res }];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, __1.Cls.classMenu.menuList(token, data)];
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, res];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, __1.Cls.cmyNotification.totalCount(token, openYn ? "Y" : "N")];
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, { data: res }];
                case 2:
